                    ...
                    <div class="d-flex align-items-center forms" @isset($item['display']) style="display: none !important;"  @endisset>
                        ...
                        <div class="inputs" style="width: 20em">
                            @if (isset($item['type']))
                                ...
                                @endif
                            @else
                                <input class="form-input" type="text" name="{{$item['col']}}" id="{{$item['col']}}" @isset($data) placeholder="{{(@$data->{$item['name']})}}" @endisset value="{{(@$contents->{$item['col']})}}" @if ($page == 'details') disabled @endif>
                            @endif
                        </div>
                    </div>
                    <br>
